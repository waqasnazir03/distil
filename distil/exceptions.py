...
class SearchExpressionNotFoundError(DistilException):
    message = _("Value not found for field using search expression")


class SearchExpressionValueTypeError(DistilException):
    message = _("Unable to parse value found for field in sample")
